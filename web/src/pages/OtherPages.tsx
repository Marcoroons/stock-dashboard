...
import { TrendingUp, Star, Lock, Zap } from 'lucide-react'
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      ...
      <EmptyState
        ...
        title="Coming soon"
        description="Set retirement, home purchase, and education goals. Calculate success probability and required monthly contributions."
        action={{ label: 'Get notified', onClick: () => {} }}
      />
    </div>
  )
}
